...
Expected output (note that long string, the container id, will differ):
```
sudo python3 main.py run -i ubuntu -- /bin/bash
new_root created @/mocker/containers/41945ec6-e49f-42ed-b709-90a955c759bc/merged
...
⠀⠀⠀⢸⣿⠀⠀⡇⠀⠀⠀⠀⣿⡀⠀⠀⠀⠀⠀⠀⠀⢀⡇⠀⠀⢀⣴⡟⠁⠀
⠀⠀⠀⠘⠿⠶⢶⢧⣦⣦⡴⢾⣥⣽⣤⣤⣤⣤⣤⣤⡴⣯⡤⠴⠶⠛⠋ happy containing :)
nobody@41945ec6-e49f-42ed-b709-90a955c759bc:/$
```
